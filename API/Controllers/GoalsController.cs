...
namespace API.Controllers
{
  public class GoalsController : BaseController
  {
    ...
    public GoalsController(IGenericService<UserGoal> goalService, IMapper mapper)
    {
    ...
    public async Task<ActionResult<GoalReturnDTO>> AddGoal(GoalOrCompInputDTO goalInput)
    {
      //create goal
      var newGoal = _mapper.Map<GoalOrCompInputDTO, UserGoal>(goalInput);
    ...
    [ProducesResponseType(typeof(ApiError), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiError), StatusCodes.Status404NotFound)]
    public async Task<ActionResult<GoalReturnDTO>> UpdateGoal(Guid id, GoalOrCompInputDTO goalInput)
    {
      //get goal
      ...
      //update goal
      _mapper.Map<GoalOrCompInputDTO, UserGoal>(goalInput, existingGoal);
