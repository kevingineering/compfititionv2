...
namespace Infrastructure.Services
{
  ...
  /*Theory
    ...
    hash functions:
      ...
      use avalanche affect - two similar inputs give vastly different results
  ...
  */
  ...
  public class PasswordService : IPasswordService
  {
    ...
    public bool CheckPassword(string inputPassword, string hashedPassword)
    {
      ...
      return CryptographicOperations.FixedTimeEquals(subkey, inputSubkey); //needs netstandard2.1+
    }
  }
}