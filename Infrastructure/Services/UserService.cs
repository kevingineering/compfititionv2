...
namespace Infrastructure.Services
{
  public class UserService : IUserService
  {
    ...
    public UserService(IUserRepo userRepo, IPasswordUtility passwordUtility, ITokenUtility tokenUtility)
    {
      _userRepo = userRepo;
    ...
    public async Task<UserResponse> UpdateUser(Guid userId, UpdateRequest request)
    {
      var user = await _userRepo.GetUser(userId);
      user.EnsureExists("User not found.");
