    ...
    public partial class RenamedProperties : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionLetters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompetitionLetters_CompetitionGoals_CompId",
                        column: x => x.CompId,
                        principalTable: "CompetitionGoals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionLetters_Users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionLetters_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                },
                comment: "Competition Letter");
            ...
            migrationBuilder.CreateTable(
                ...
                comment: "Competition Participant");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionLetters_CompId",
                table: "CompetitionLetters",
                column: "CompId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionLetters_ReceiverId",
                table: "CompetitionLetters",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetitionLetters_SenderId",
                table: "CompetitionLetters",
                column: "SenderId");
