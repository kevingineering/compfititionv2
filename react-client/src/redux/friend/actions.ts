...
export const GetFriend = (id: string) => async (
  dispatch: ThunkDispatch<{}, {}, FriendDispatchTypes>
) => {
  try {
    dispatch({ type: FRIEND_LOADING, payload: NO_BUTTON });
...
export const DeleteFriend = (id: string) => async (
  dispatch: ThunkDispatch<{}, {}, FriendDispatchTypes>
) => {
  try {
...
export const SetFriendSelectedGoal = (id: string) => (
  dispatch: Dispatch<FriendDispatchTypes>
) => {
  dispatch({ type: SET_FRIEND_CURRENT_GOAL, payload: id });
};
